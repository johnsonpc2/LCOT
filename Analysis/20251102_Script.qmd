...
dt_results$sona_id[] -> retained_subjects
```
...
```{r}
qual_cols <- c("sona_id", "phase", "stimulus", "response")

dt[, ..qual_cols] -> dt_demo_sub

dt[sona_id == unique(retained_subjects), ] -> dt_demo_sub
```
