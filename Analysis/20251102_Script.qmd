...
# Load packages
c("beepr", "data.table", "ggplot2",
  "ggridges", "here", "pcjtools") |>
...
who had average response times \< 30 seconds and had an average confidence in
their ratings \> 0.5.
...
ggplot(
  ...
  labs(
    ...
    y = "Contingency",
    fill = "Block",
    title = "Distribution of Confidence Scores by Subject and Block"
  )
```
